...
//pagetite
$lang['pagetitle'] = 'Пользователи системы';

// Login
$lang['login_heading']         = 'Сервис доставки';
$lang['login_subheading']      = 'ДЛЯ ПРОДОЛЖЕНИЯ РАБОТЫ ВВЕДИТЕ ЛОГИН И ПАРОЛЬ';
$lang['login_identity_label']  = 'Ваш логин:';
$lang['login_password_label']  = 'Ваш пароль:';
$lang['login_remember_label']  = 'Запомнить меня:';
$lang['login_submit_btn']      = 'Продолжить';
$lang['login_forgot_password'] = 'Забыли свой пароль?';

// Index
$lang['index_heading']           = 'Пользователи';
$lang['index_subheading']        = 'Доступный список пользователей системы';
...
/*register user*/
$lang['reg_pagetitle']    = 'Регистрация';
$lang['reg_create_account']    = 'Создать аккаунт';
$lang['reg_agreement']    = 'Я согласен';
$lang['reg_agreement_link']    = 'с условиями соглашения';
$lang['reg_button']    = 'Зарегистрироваться';
$lang['reg_allready']    = 'Уже есть аккаунт?';
$lang['reg_login']    = 'Войти';
