...
class Auth extends CI_Controller
{
    ...
    function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->library(array('ion_auth', 'form_validation', 'elex','phpmailer'));
    ...
    function register()
    {
        $this->data['pagetitle'] = $this->lang->line('reg_pagetitle');
        $this->data['reg_create_account'] = $this->lang->line('reg_create_account');
        $this->data['reg_agreement'] = $this->lang->line('reg_agreement');
        $this->data['reg_agreement_link'] = $this->lang->line('reg_agreement_link');
        $this->data['reg_button'] = $this->lang->line('reg_button');
        $this->data['reg_allready'] = $this->lang->line('reg_allready');
        $this->data['reg_login'] = $this->lang->line('reg_login');

        if ($this->ion_auth->logged_in()) {
            /*Если уже зарегн, перенаправляем на личную страницу*/
